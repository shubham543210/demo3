...
public class Details2Controller {
	...
	public Details2 details2GetByJpa()
	{
	 ...
	 @RequestMapping("/details2/filter/{firstName}")
	    public List<Details2> getFiltered(@PathVariable String firstName) {
	        return details2Repository.getFirstNamesLike(firstName);
	    }
